$('#frmActivateUser').on('submit', function (event) {
    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        Swal.fire({
          title: 'Email enviado',
          text: 'Email con PIN fue enviado a tu correo electrónico',
          type: 'success',
          showCancelButton: false,
          confirmButtonColor: '#3085d6',
          confirmButtonText: 'Entendido'
        }).then(function (result) {
          window.location.href = 'http://' + window.location.host + '/users/pwdrecovery.html';
        });
      },
